...
import regionsud from './images/regionsud.png';
...
const metadata = new ChartMetadata({
  ...
  exampleGallery: [{ url: regionsud }, { url: drapeau }],
  name: t('Qleroy Country Map'),
  tags: [
    t('2D'),
    t('Comparison'),
    t('Geo'),
...
export default class QleroyCountryMapChartPlugin extends ChartPlugin {
  constructor() {
    super({
